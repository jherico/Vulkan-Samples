...
void HPPResourceReplay::play(ResourceCache &resource_cache, ResourceRecord &recorder)
{
...
void HPPResourceReplay::create_shader_module(ResourceCache &resource_cache, std::istringstream &stream)
{
...
void HPPResourceReplay::create_pipeline_layout(ResourceCache &resource_cache, std::istringstream &stream)
{
...
void HPPResourceReplay::create_render_pass(ResourceCache &resource_cache, std::istringstream &stream)
{
...
void HPPResourceReplay::create_graphics_pipeline(ResourceCache &resource_cache, std::istringstream &stream)
{
