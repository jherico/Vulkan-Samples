...
void VulkanSample::draw(CommandBuffer &command_buffer, RenderTarget &render_target)
{
	...
	for (size_t i = 0; i < views.size(); ++i)
	{
		...
		vkb::insert_image_memory_barrier(
		    ...
		    vk::PipelineStageFlagBits::eColorAttachmentOutput, vk::PipelineStageFlagBits::eColorAttachmentOutput, subresource_range);
	}

	auto &depth_view              = views.at(1);
	auto &depth_image             = depth_view.get_image();
	auto &depth_subresource_range = depth_view.get_subresource_range();
	vkb::insert_image_memory_barrier(
	    command_buffer,
	    ...
	    vk::PipelineStageFlagBits::eLateFragmentTests, vk::PipelineStageFlagBits::eLateFragmentTests, depth_subresource_range);

	draw_renderpass(command_buffer, render_target);

	auto &final_view              = views.at(0);
	auto &final_image             = depth_view.get_image();
	auto &final_subresource_range = final_view.get_subresource_range();

	vkb::insert_image_memory_barrier(
	    command_buffer,
	    final_image.get_handle(),
	    vk::AccessFlagBits::eColorAttachmentWrite, vk::AccessFlagBits::eDepthStencilAttachmentWrite,
	    vk::ImageLayout::eColorAttachmentOptimal, vk::ImageLayout::ePresentSrcKHR,
	    vk::PipelineStageFlagBits::eColorAttachmentOutput, vk::PipelineStageFlagBits::eBottomOfPipe, final_subresource_range);
}
